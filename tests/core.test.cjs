...
const {Settings,normalizeGateway}=require('../src/main/settings.cjs'),{Service,policy}=require('../src/main/service.cjs'),{streamChat}=require('../src/main/http.cjs'),{createWorker}=require('../src/main/worker.cjs'),{download}=require('../src/main/downloads.cjs');
